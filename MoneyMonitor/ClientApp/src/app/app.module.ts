...
import { ConfigureWealthComponent } from './configure-wealth/configure-wealth.component';
...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forRoot([
      ...
      { path: 'configure-wealth/:id', component: ConfigureWealthComponent, canActivate: [AuthorizeGuard] },
    ])
  ],
  providers: [
